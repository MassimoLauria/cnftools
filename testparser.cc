...
void TestDimacsParser::spec_line_parse()
  {
    ...
    CPPUNIT_ASSERT_MESSAGE("Parser must fail on negative number of clauses",
                           parser_throws<dimacs_bad_syntax>("p  cnf 1 -4"));
    CPPUNIT_ASSERT_MESSAGE("Parser must not fail on zero number of clauses",
                           !parser_throws<dimacs_bad_syntax>("p  cnf 1 0"));
    CPPUNIT_ASSERT_MESSAGE("Parser must not fail on zero number of variables",
                           !parser_throws<dimacs_bad_syntax>("p  cnf 0 2\n 0\n 0"));
    CPPUNIT_ASSERT_MESSAGE("Parser must not fail on empty clauses",
                           !parser_throws<dimacs_truncated>("p  cnf 0 2\n 0\n 0"));
    CPPUNIT_ASSERT_MESSAGE("Parser must fail on bad spec line",
                           parser_throws<dimacs_bad_syntax>("p  cnfx 4 4"));
    CPPUNIT_ASSERT_MESSAGE("Parser must fail on bad spec line",
                           parser_throws<dimacs_bad_syntax>("p  cnf x 4 4"));
    CPPUNIT_ASSERT_MESSAGE("Spec line is on a single line and has not other data.",
                           parser_throws<dimacs_bad_syntax>("p  cnf 4 1 a \n 1 2 0"));
    CPPUNIT_ASSERT_MESSAGE("Spec line is on a single line and has not other data.",
                           parser_throws<dimacs_bad_syntax>("p  cnf 4 1 a \n 1 2 0"));
    CPPUNIT_ASSERT_MESSAGE("Spec line is on a single line and has not other data.",
...
void TestDimacsParser::read_clauses() {
  CPPUNIT_ASSERT_MESSAGE("No clauses in input",
                         parser_throws<dimacs_truncated>("p  cnf 1 4"));
  ...
  CPPUNIT_ASSERT_MESSAGE("Test for missing clauses",
                         parser_throws<dimacs_truncated>("p  cnf 3 4\n 2 3 -1 0"));
